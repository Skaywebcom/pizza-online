          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8'>
            {[
              ...
              },
              {
                ...
                rating: 5,
                text: "Fast delivery, hot pizza, and amazing flavors. JaybiePizza has become our family's go-to for pizza nights!",
              },
              {
                name: 'Emma Wilson',
                role: 'Local Resident',
